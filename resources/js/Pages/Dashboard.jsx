        ...
        >
            ...
            <div className="flex flex-col">
                ...
                <div className="max-w-7xl mt-10 mx-auto w-full max-[633px]:p-6">
                    ...
                    <div className="py-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 max-[633px]:p-6">
                            {/* Cards */}
                            <div className="bg-white border text-black p-4 rounded-lg shadow border-[#fcb609]">
                                            ...
                                            <Form className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 w-full">
                                                <div className="flex-1">
                                                    <Field
                                                        as="select"
                                                        name="status"
                                                        className="py-2 pr-7 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 w-full"
                                                        onChange={(e) => {

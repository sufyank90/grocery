                                        ...
                                        <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50     hover:bg-gray-100      ">
                                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                {!values.file ? (<>
                                                    ...
                                                    <p class="text-xs text-gray-500  ">SVG, PNG, JPG , GIF, WEBP, BMP, TIFF (MAX. 800x400px)</p>
                                                </>) : (
                                                    <>
                                            ...
                                            <input onChange={(event) => {
                                                ...
                                                const allowedTypes = ['image/svg+xml', 'image/png', 'image/jpg', 'image/jpeg', 'image/gif', 'image/webp', 'image/apng', 'image/avif'];
                                                if (!allowedTypes.includes(fileType)) {
                                                    toast.error('Unsupported file type. Only SVG, PNG, JPG, JPEG, GIF, WEBP, BMP, TIFF are allowed.');
                                                    return;
                                                }

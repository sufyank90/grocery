...
function Edit(props) {
    ...
    const removeThumbnailFromFiles = product?.media?.length > 0
        ? product.media.slice(1).map(media => ({ url: media.original_url, id: media.id }))
        : [];
                    ...
                    <div className="block w-2/4 p-6 bg-white border border-gray-200 rounded-lg shadow  mb-10">
                        ...
                        <Formik
                            initialValues={{
                                ...
                                status: product.status ? product.status : 'instock',
                                ...
                                return (
                                    <Form>
                                            ...
                                            {values.thumbnail && (
                                                <div className="relative flex items-center justify-between bg-[#f3d08140] px-2 py-2 rounded-lg">
                                                    <img
                                                        ...
                                                        src={values.thumbnail.url ? values.thumbnail.url : URL.createObjectURL(values.thumbnail)}
                                        ...
                                        <div className="w-full space-y-4">
                                            {values.file && values.file.length > 0 && Array.from(values.file).map((file, index) => (
